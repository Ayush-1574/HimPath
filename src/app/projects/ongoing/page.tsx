...
import { ArrowRight, CheckCircle2, DollarSign, Calendar, MapPin, Sparkles, FolderKanban } from 'lucide-react';
import { ongoingProjectsList } from '@/lib/siteData';

export const metadata = {
  title: 'Ongoing Funded Projects | HiMPaTH - IIT Ropar',
  description: 'Detailed dossiers of active sponsored research grants funded by ANRF, NMHS, and ISIRD at IIT Ropar.',
};
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 pb-6 border-b border-[#eef4f3]">
                ...
                <div className="shrink-0 bg-[#f7faf9] p-4 rounded-2xl border border-[#dbe5e4] text-right self-start">
                  <span className="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Total Grant Value</span>
              ...
              <div className="pt-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  <div className="p-6 bg-[#f7faf9] rounded-2xl border border-[#dbe5e4]">
                    <h3 className="text-xs font-black uppercase tracking-wider text-[#258b82] mb-3">Project Objectives</h3>
